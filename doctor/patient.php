...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo $selecttype." Patient Details (".$list11->num_rows.")"; ?></p>
                    </td>
        ...
        $action=$_GET["action"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="150%" class="sub-table scrolldown add-doc-form-container" border="0">
                        
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Patient History Details</p><br><br>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <a href="?action=add-progress&id=none&error=0"?>
                                        <input type="button" value="Add Progress" class="login-btn btn-primary-soft btn">
                                    </a>
                                </td>
                            </tr>
                            ...
                            <td colspan="4">
                                <center>
                                 ...
                                 SELECT 
                                     ...
                                     appointment.progress AS progress,
        ...
        if ($action == 'add-progress') {
            ...
            <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <tr>
                            <td class="label-td" colspan="2">
                               <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add Patient Progress.</p><br>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                            <form action="add-progress.php" method="POST" class="add-new-form">
                        </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="appointment_id">Select Session:</label>
                                ...
                                while ($appointment = $appointment_result->fetch_assoc()) {
                                    echo '<option value="' . $appointment["appoid"] . '">' . $appointment["title"] . '</option>';
                                }
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                ...
                                <input type="text" name="progress_details" class="input-text" placeholder="patient progress" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <input type="reset" value="Reset" class="login-btn btn-primary-soft btn" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="submit" value="Add Progress" class="login-btn btn-primary btn" name="shedulesubmit">
                            </td>
                        </tr>
                        </form>
                    </table>
