 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
                     ...
                     <table border="0" class="profile-container">
                         <tr>
                             <td width="30%" style="padding-left:20px" >
                                 <img src="../img/ya.png" alt="" width="100%" style="border-radius:50%">
                             </td>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.MeetingLink,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid where doctor.docid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <table width="98%" class="sub-table scrolldown" border="0">
                        <thead>
                        <tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                             <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Therapist Name: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">';

                                    $list11 = $database->query("SELECT docname, docid FROM doctor WHERE docid = $userid;");
                                    ...
                                    if ($list11->num_rows > 0) {
                                        ...
                                        echo '<input type="text" class="input-text" value="' . htmlspecialchars($docName) . '" readonly>';
                                        echo '<input type="hidden" name="docid" value="' . htmlspecialchars($docId) . '">';
                                    } else {
                        ...
                        echo     '      <br>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="meetinglink" class="input-text" placeholder="enter meeting link" required><br>
                                </td>
                            </tr>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,schedule.scheduledate,schedule.scheduletime,schedule.MeetingLink,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $meetinglink=$row["MeetingLink"];
            $scheduleid=$row["scheduleid"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Meeting Link: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
