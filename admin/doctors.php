            ...
            if ($error_1 != '4') {
                ...
                <div id="popup1" class="overlay">
                    ...
                    . '</td>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <input type="text" name="name" class="input-text" placeholder="DTherapist Name" required><br>
                                    </td> 
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                ...
                echo     '       </select><br>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <input type="password" name="password" class="input-text" placeholder="Create a Password" required><br>
                                    </td>
                                </tr><tr>
                                    <td class="label-td" colspan="2">
                ...
                echo '
                        <div id="popup1" class="overlay">
                                ...
                                <center>
                                <br><br><br><br>
                                    <h2> New Doctor Record Added Successfully!</h2>
                                    <a class="close" href="doctors.php">&times;</a>
                                    <div class="content">   
                                    </div>
                                    <div style="display: flex;justify-content: center;">
            ...
            if ($error_1 != '4') {
                ...
                echo '
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                            <br><br><br><br>
                                <h2>Edited Doctor Data Successfully!</h2>
                                <a class="close" href="doctors.php">&times;</a>
                                <div class="content">   
                                </div>
                                <div style="display: flex;justify-content: center;">
