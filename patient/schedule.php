 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="history.php" class="non-style-link-menu"><div><p class="menu-text">My History</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                                    ...
                                    if ($result->num_rows == 0) {
                                        ...
                                        for ($x = 0; $x < ($result->num_rows); $x++) {
                                            ...
                                            for ($q = 0; $q < 3; $q++) {
                                                ...
                                                // Display button based on availability
                                                if ($currpatients < $nop) {
                                                   ...
                                                   // $newCurrPatients = $row['currpatients'] + 1;
                                                   // $updateQuery = "UPDATE schedule SET currpatients = '$newCurrPatients' WHERE scheduleid = '$scheduleid'";

                                                } else {
                                                    echo '<button class="login-btn btn-secondary-soft btn" style="padding-top:11px;padding-bottom:11px;width:100%" disabled><font class="tn-in-text">Fully Booked</font></button>';
                                                }
