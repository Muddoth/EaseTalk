...
<body>
    ...
    $action = isset($_GET['action']) ? $_GET['action'] : 'default'; // Default action if not set
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="doctors.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">All Therapist</p></a></div>
                    </td>
                </tr>
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Therapist(<?php echo $list11->num_rows; ?>)</p>
                    </td>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to Therapist sessions?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
